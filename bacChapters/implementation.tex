...
\begin{algorithm}
\SetKwFunction{GetPlugin}{GetPlugin}
\SetKwFunction{GetProperty}{GetProperty}{"Plane Translation Vector"}
...
The dot product of the plane normal and the vertex position minus a point on the plane states if the vertex is in front of or behind the plane.%~\ref{eq:positionOfPixel}.
